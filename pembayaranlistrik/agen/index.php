...
<html>
<head>
	<title>Form Login ListrikKu Payment</title>
	<link rel="stylesheet" type="text/css" href="../css/bootstrap.css">
</head>
<body style="background:url('../images/bg_agen.png');">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
					...
					<div class="panel panel-default">
						...
						<div class="panel-heading">
							<div style="margin-top: 5px;margin-bottom: 5px;">
								<img src="../images/logo_setroomutama.png" alt="logo" class="logo" width="90px">
							</div>
						...
						<div class="panel-footer">
							<center>&copy;<?php echo date("Y"); ?> - Romadhon</center>
